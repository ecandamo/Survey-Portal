...
export const SurveySchema = z.object({
  ...
  pipelineOther: z.string().max(5000).optional().or(z.literal("")),
  huddleChanges: z.array(z.string()).max(2),
  huddleOther: z.string().max(5000).optional().or(z.literal("")),
  meetingTiming: z.enum(["Works well", "Somewhat challenging", "Very challenging"]),
  improveOneThing: z.string().max(5000).optional().or(z.literal("")),
  anythingElse: z.string().max(5000).optional().or(z.literal(""))
});
